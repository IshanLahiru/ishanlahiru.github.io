...
const DeckDrillTermsPage: React.FC = () => {
  return (
    <LegalPageLayout
      title="DeckDrill Terms & Conditions"
      ...
      <P>
        ...
        support.ishanvithanage@gmail.com. Where the Service Provider is established outside the
        European Union, a legal representative in the EU has been designated in accordance with
      ...
      <P>
        ...
        illegal content through the contact details provided in these Terms. The Service Provider
        will process notices promptly, diligently, and without automated decision-making where the
      ...
      <P>
        ...
        service under the DSA and does not replace or limit any rights or obligations under
        applicable consumer protection or data protection law.
      </P>
...
export default DeckDrillTermsPage;
