...
const DeckDrillPrivacyPolicyPage: React.FC = () => {
  return (
    <LegalPageLayout
      title="DeckDrill Privacy Policy"
      ...
      <P>
        ...
        Provider will use appropriate mechanisms.
      </P>
      <UL
        items={[
      ...
      />
      <P>
        Data protection laws in other countries may differ from those in your jurisdiction. Where
        required by law, the Service Provider will apply appropriate safeguards and obtain any
      ...
      <P>
        ...
        rights, contact the Service Provider at support.ishanvithanage@gmail.com.
      </P>
      ...
      <H2>Children</H2>
      <P>
        The Application is not intended for children under 18 years of age, or such higher age as
...
export default DeckDrillPrivacyPolicyPage;
