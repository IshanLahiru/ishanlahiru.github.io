...
const DammapadayaTermsPage: React.FC = () => {
  return (
    <LegalPageLayout
    ...
    >
      ...
      <P>
        The Pāli verses presented in the Application are a traditional Buddhist text in the public
        ...
        open-license terms. The Service Provider does not claim proprietary ownership of the
        underlying verses or their translation. The Application's software, its selection and
        arrangement of content, and its design remain the intellectual property of the Service
        Provider. If you believe any content in the Application infringes a right you hold, contact
        the Service Provider at ishanlahiru2002@gmail.com and it will be reviewed promptly.
      </P>
      ...
      <P>
        ...
        Provider takes care to present the Dhammapada's verses and their rendering accurately, the
        Application is not a substitute for guidance from a qualified teacher or monastic for
        questions of doctrine or practice.
      </P>
      <P>
        Fetching the latest verse content requires an active internet connection; previously loaded
        content remains available offline, and the Application also ships with the full text bundled
        in, so it always has something to show even offline. The Service Provider cannot be held
        responsible if the Application does not function at full capacity due to lack of internet
        access.
      </P>
      <P>
      ...
      <P>
        ...
        claim shall not exceed the minimum amount that must be paid under applicable law. As the
        Application is provided entirely free of charge, no amount has ever been paid for it.
      </P>
...
export default DammapadayaTermsPage;
