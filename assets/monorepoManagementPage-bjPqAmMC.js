const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/mermaid.core-DKMcHji_.js","assets/index-q6clC6v9.js","assets/index-BQeKKZnS.css"])))=>i.map(i=>d[i]);
import{r as i,_ as u,j as e}from"./index-q6clC6v9.js";import{B as b,D as l,H as t,C as m}from"./prose-Cm-ufG3z.js";import"./Footer-BQebJD8S.js";import"./toolTipWrapper-DELcdNkl.js";import"./createLucideIcon-CrZzB8eC.js";import"./index-BtngXPDV.js";import"./arrow-left-dd8GWLfI.js";import"./clock-B0l-TdFk.js";let d=!1;const c=({chart:r,id:o})=>{const[n,p]=i.useState("");return i.useEffect(()=>{let s=!1;return u(()=>import("./mermaid.core-DKMcHji_.js").then(a=>a.bz),__vite__mapDeps([0,1,2])).then(async({default:a})=>{d||(a.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:"#000000",primaryColor:"#18181b",primaryTextColor:"#f4f4f5",primaryBorderColor:"#f97316",lineColor:"#71717a",secondaryColor:"#27272a",tertiaryColor:"#18181b"}}),d=!0);const{svg:h}=await a.render(o,r);s||p(h)}),()=>{s=!0}},[r,o]),e.jsxs("div",{className:"overflow-x-auto rounded-2xl border border-white/10 bg-zinc-900 p-6",children:[e.jsx("div",{dangerouslySetInnerHTML:{__html:n}}),!n&&e.jsx("p",{className:"text-xs text-slate-500",children:"Rendering diagram…"})]})},g=`{
